...
class VendaTest < ActiveSupport::TestCase
  test 'Nao deve salvar uma venda com todos os campos em branco' do
      ...
      assert_not vendaTeste.save, "Venda nao foi salva. Campos nao devem estar em branco"
  end

  test 'Nao deve salvar uma venda com o id_produto em branco' do
      vendaTeste = Venda.new()
      assert_not vendaTeste.save, "Venda nao foi salva. Produto nao pode estar em branco"
  end
  ...
  test 'Nao deve salvar uma venda com a quantidade em branco' do
      ...
      assert_not vendaTeste.save, "Venda nao foi salva. Quantidade nao pode estar em branco"
  end
end
