...
class EnderecoTest < ActiveSupport::TestCase
  ...
  test 'Nao deve salvar um endereco com todos os campos em branco' do
      ...
      assert_not endTeste1.save, "Endereco nao foi salvo. Campos nao podem estar em branco."
  end
  ...
  test 'Nao deve salvar um endereco com cidade invalida' do
      ...
      assert_not endTeste2.save, "Endereco nao foi salvo. Nome de cidade invalido."
  end
end
